...
export class CreateUserUseCase {
  constructor(private usersRepository: UsersRepository, private usersTempRepository: UsersTempRepository) {
    this.usersRepository = usersRepository;
    this.usersTempRepository = usersTempRepository;
  }

  async execute({code, email}: CreateUserRequest): Promise<CreateUserResponse> {
