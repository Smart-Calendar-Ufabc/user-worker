...
export class CreateUserTempUseCase {
  constructor(private usersTempRepository: UsersTempRepository, private usersRepository: UsersRepository) {}

  async execute({email, password}: CreateUserTempRequest): Promise<CreateUserTempResponse> {
    ...
    console.log(`Sign-up code validate: ${code}`)
